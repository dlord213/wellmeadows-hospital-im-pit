...
<body class="bg-slate-100">
  ...
  <main class="max-w-7xl w-full xl:mx-auto xl:mt-4 xl:p-0 p-4">
    <?php if ($staff_position == 'Charge Nurse'): ?>
      <?php require './charge_nurse/charge_nurse_dashboard_component.php' ?>
    <?php endif; ?>
    <?php if ($staff_position == 'Medical Director'): ?>
      <?php require './medical_director/medical_director_dashboard_component.php' ?>
    <?php endif; ?>
    <?php if ($staff_position == 'Doctor'): ?>
      <?php require './doctor/doctor_dashboard_component.php' ?>
    <?php endif; ?>
  </main>
</body>
